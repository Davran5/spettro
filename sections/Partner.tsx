...
const FORM_CONFIG = {
    scriptUrl: "https://script.google.com/macros/s/AKfycbyYYciBUuoG2tHblOd9lnl5fUiIVJfOgnYtnoV3mfAF5VtXCjuSghtba2BgQhVr69moVQ/exec",
};
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (FORM_CONFIG.scriptUrl) {
                ...
                // Map the internal ID to the specific English string the script expects
                ...
                data.append('interest', interestMapping[formData.interest] || formData.interest);
                data.append('name', formData.name);
                data.append('phone', formData.phone);
                data.append('email', formData.email);
                data.append('message', formData.message);

                await fetch(FORM_CONFIG.scriptUrl, {
                    method: 'POST',
                    body: data
                });
            } else {
                // Simulation
                console.log("Form Data Ready for Script:", formData);
                    ...
                    <div className="order-1 flex flex-col justify-center h-full pt-0 lg:pt-10">
                        ...
                        <div className="hidden lg:block mt-8">
                            ...
                            <div className="flex items-center gap-4 text-gray-300 mb-2">
                                ...
                                <span className="font-mono text-base">+998 94 814 5005</span>
                            </div>
                            <div className="flex items-center gap-4 text-gray-300">
                                ...
                                <span className="font-mono text-base">info@spettro.uz</span>
                            </div>
                        </div>
                    </div>
